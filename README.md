...
>
> 🔥 **[Download v1.1.1-rp2040 firmware (.uf2 drag-and-drop)](https://github.com/semichcsc-byte/Open-Chess/releases/latest)**
>
> v1.1 fixes a **column-mirror bug** that was making all serial-monitor chess notation appear mirrored across the a-h axis on every previous release (including upstream). v1.1.1 adds a slow breathing pulse on the bot's back rank while it thinks (and fixes the SSL handshake corruption that the first attempt at this animation introduced).
>
...
| Patched firmware released | ✅ [v1.1.1-rp2040](https://github.com/semichcsc-byte/Open-Chess/releases/latest) |
